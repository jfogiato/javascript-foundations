...
it('should have a name and be interpolated with "The Great"', function() {
...
it('should have a favorite accessory and default to top hat', function() {
    var magician = new Magician({ name: 'Scott' });

    assert.equal(magician.favoriteAccessory, 'top hat');
  });

it('should be able to update favorite accessory', function() {
...
it('should pull from the sleeve if the clothing is a cape', function() {
...
it('should have a default confident percentage of 10', function() {
    var magician = new Magician({ name: 'Leta' });

    assert.equal(magician.confidencePercentage, 10);
  });

it('should gain 10 percent confidence each time it performs a trick', function() {
    var magician = new Magician({ name: 'Leta' });
...
it('should only perform show stopper if they have performed 10 or more tricks', function() {
...
it('should only be able to perform the show stopper if they have an assistant and have done 10 tricks', function() {
